...
begin
  ...
  Assert.AreEqual('Тест', TrimString('  Тест  '),
...
begin
  ...
  Assert.AreEqual('ТЕСТ', ToUpperCaseString('Тест'),
...
begin
  ...
  Assert.AreEqual('тест', ToLowerCaseString('Тест'),
...
begin
  ...
  Assert.IsTrue(IsAlphaNumeric('Тест123'),
    'IsAlphaNumeric failed for "Тест123".');
...
begin
  ...
  Assert.AreEqual('Cyrillic тест.', ReplaceSubstring('Cyrillic sample.',
    'sample', 'тест'), 'ReplaceSubstring failed with Cyrillic characters.');
end;
